...
<body class="hold-transition login-page" style="background-image: url(<?php echo base_url();?>asset/images/dawn.jpg); background-size:cover;">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session TEMPLATEEE</p>
