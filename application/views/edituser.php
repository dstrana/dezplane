            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>admin_con/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
        ...
        <?php foreach($user as $u){ ?>
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="hidden" id="username" class="form-control" value="<?php echo $u->id ?>" name="username" required>
                <input type="text" id="username" class="form-control" value="<?php echo $u->username ?>" name="username" required>
              </div>
              <div class="form-group">
                <label>Password</label>
                <input type="password" id="password" class="form-control" value="<?php echo $u->password ?>" name="password" required>
              </div>
              <div class="form-group">
                <label>Fullname</label>
                <input type="text" id="fullname" class="form-control" value="<?php echo $u->fullname ?>" name="fullname" required>
              </div>
              <div class="form-group">
                <label>Level</label>
                <input type="text" id="level" class="form-control" value="<?php echo $u->level ?>" name="level" required>
              </div>
              <div class="form-group">
                <input type="submit" name="Simpan" value="Simpan" class="btn btn-primary">
                <a href="<?php echo base_url();?>admin_con" class="btn btn-primary">Kembali</a>
              </div>
              <?php } ?>
            </form>
            </div>
