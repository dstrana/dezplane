  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo base_url(); ?>admin_con"><i class="fa fa-home"></i> <span>Data User</span></a></li>
        <li class="active"><a href="<?php echo base_url(); ?>admin_con/rute"><i class="fa fa-road"></i> <span>Rute</span></a></li>
        <li class="treeview">
    ...
    <section class="content container-fluid">
          <div class="box">
            ...
            <div class="box-header">
              <a href="<?php echo base_url(); ?>admin_con/tambahrute" class="btn btn-primary">Tambah</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $u->transit_place ?></td>
                  <td><?php echo $u->price ?></td>
                  <td><?php echo $u->transportation_id ?></td>
                  <td><a href="<?php echo base_url(); ?>admin_con/edituser/<?php echo $u->id?>" class="btn btn-warning">Edit</a>
                     <a onclick="return confirm('Hapus data??');" href="<?php echo base_url(); ?>admin_con/hapususer/<?php echo $u->id?>" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
