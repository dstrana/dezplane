...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo url_assets;?>/admin/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
  <from action="<?php echo base_url('login/cek_login'); ?>" method="post">
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>LOGIN ADMINNNNN</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session AZHARRR</p>
    ...
    <form action="login" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" value="login/indexadmin" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
