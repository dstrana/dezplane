  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>admin_con"><i class="fa fa-home"></i> <span>Data User</span></a></li>
        <li><a href="<?php echo base_url(); ?>admin_con/rute"><i class="fa fa-road"></i> <span>Rute</span></a></li>
        <li class="treeview">
    ...
    <section class="content container-fluid">
          <div class="box">
            ...
            <div class="box-header">
              <a href="<?php echo base_url(); ?>admin_con/tambahuser" class="btn btn-primary">Tambah</a>
            </div>
            <div class="box-body">
